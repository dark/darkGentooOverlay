...
LICENSE="LGPL-2.1"
SLOT="0"
IUSE="alsa capi cups dibengine dbus esd fontconfig +gecko gnutls gphoto2 gsm hal jack jpeg lcms ldap mp3 nas ncurses openal +opengl oss png samba scanner ssl test +threads win64 +X xcomposite xinerama xml"
RESTRICT="test" #72375

...
# dark: rimuovo questa dipendenza, mantengo solo =dev-libs/gmime-2.2*, così non installo inutilmente
# lo slot 2.4 di dev-libs/gmime (che non sarebbe comunque usato da questo ebuild)

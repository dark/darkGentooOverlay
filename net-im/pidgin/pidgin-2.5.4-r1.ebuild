...
pkg_setup() {
	einfo "dark: please, use me temporary! Upgrade me"
	einfo "as soon as CPU hog problems are resolved with >=pidgin-2.5.5"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-icq-messages-magic.patch
}

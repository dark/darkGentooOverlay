...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/slim/slim-1.3.2-r7.ebuild,v 1.2 2012/01/30 21:10:01 ago Exp $
...
IUSE="branding pam consolekit xinerama"
...
src_prepare() {
	if use xinerama; then
		epatch "${FILESDIR}/${PN}-xinerama.patch"
	fi
